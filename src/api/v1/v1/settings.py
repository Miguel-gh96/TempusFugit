...
import os
from .email_config import GMAIL_USE_TLS, GMAIL_HOST, GMAIL_HOST_USER, GMAIL_HOST_PASSWORD, GMAIL_PORT
...
SECRET_KEY = 'zw!lj)l^9#nijmugsks9#&wha(qttw#fv*&1@g6_tz0pm&+0)f'
